...
glance(homework7_lm)
```
Based on the r-squared value for linear fit, homework 7's features were better fitting.
...
```
The p-value is 1, so the conversion rates for Version A and B are not significantly different than each other
